...
- 정답이 없는 열린 질문
- 자기 발견을 돕는 질문
- 예시: "오늘 가장 편안했던 순간은?", "나에게 '괜찮아'라고 말해준다면?"`,note:"강제하지 않고, 답하지 않아도 되는 분위기로"}]},implementation:{frontend:{description:"감정 체크인 UI, 루틴 카드, 격려 화면, 성찰 저널, 회복 그래프",pages:["감정 체크인 (이모지 + 점수)","오늘의 루틴 (카드형 추천)","격려 & 성찰 (저널링)","회복 그래프 (주간/월간)","루틴 히스토리","설정 (알림 시간)"],stack:"React 19 + TypeScript + Chart.js + Tailwind + 이모지"},backend:{description:"감정 기록, 루틴 추천/수행 관리, 격려 생성",apis:["POST /checkin — 감정 체크인","POST /routine — 루틴 추천","POST /complete — 루틴 완료 체크","POST /encourage — 격려 메시지","POST /reflect — 성찰 질문","GET /stats — 회복 통계"],stack:"Supabase Edge Functions + Solar API"},database:{tables:[{name:"solar_emotions",fields:"id, user_id, score(1-10), keywords(text[]), note, created_at"},{name:"solar_routines",fields:"id, user_id, date, recommended(jsonb), completed(jsonb), created_at"},{name:"solar_journals",fields:"id, user_id, question, answer, created_at"}]}},deployment:{steps:["프론트엔드 빌드 & 배포","Edge Functions 배포","Solar API Key 등록","알림 시스템 설정 (Push/Email)","베타 테스트 (심리상담사 감수)"],infra:"GitHub Pages + Supabase + Solar API + Web Push"},expansion:["청년 회복 프로그램 공식 도구 채택","정서지원 AI 서비스 (범용)","CBT(인지행동치료) 기반 확장","사회복지사 모니터링 대시보드","마음건강 커뮤니티 연계"]}],d=148,p=52,A=38,f=30,S=16,D={1:{nodes:[{id:"a",label:"사용자 입력",sub:"나이·주제",row:0,col:0},{id:"b",label:"Solar Chat",sub:"스토리 생성",row:0,col:1},{id:"c",label:"장면 분할기",sub:"5~8 장면",row:0,col:2},{id:"d",label:"삽화 프롬프트",sub:"생성기",row:1,col:2},{id:"e",label:"독후활동 생성",sub:"질문·교훈",row:1,col:1},{id:"f",label:"동화 뷰어",sub:"최종 출력",row:2,col:1}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"d"},{from:"d",to:"e"},{from:"e",to:"f"}]},2:{nodes:[{id:"a",label:"문화재청 API",sub:"공공데이터",row:0,col:0},{id:"b",label:"전처리·청킹",sub:"텍스트 분할",row:0,col:1},{id:"c",label:"Solar Embed",sub:"벡터화",row:0,col:2},{id:"d",label:"수준별 해설",sub:"+ 퀴즈 출력",row:1,col:0},{id:"e",label:"Solar Chat",sub:"RAG 생성",row:1,col:1},{id:"f",label:"pgvector",sub:"벡터 검색",row:1,col:2},{id:"g",label:"사용자 질의",sub:"문화재·수준",row:2,col:1}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"f"},{from:"f",to:"e"},{from:"e",to:"d"},{from:"g",to:"f"},{from:"g",to:"d"}]},3:{nodes:[{id:"a",label:"한국사 DB",sub:"시대별 구조",row:0,col:0},{id:"b",label:"수준별 설명",sub:"Solar 생성",row:0,col:1},{id:"c",label:"학습 뷰어",sub:"읽기·듣기",row:0,col:2},{id:"d",label:"문제 생성",sub:"유형별",row:1,col:0},{id:"e",label:"풀이 & 채점",row:1,col:1},{id:"f",label:"오답 분석",sub:"+ 리포트",row:1,col:2},{id:"g",label:"적응형 복습",sub:"취약 시대",row:2,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"a",to:"d"},{from:"c",to:"f"},{from:"d",to:"e"},{from:"e",to:"f"},{from:"f",to:"g"}]},4:{nodes:[{id:"a",label:"문제 은행",sub:"자격증별",row:0,col:0},{id:"b",label:"문제 풀기",sub:"사용자",row:0,col:1},{id:"c",label:"자동 채점",sub:"+ 단원 태깅",row:0,col:2},{id:"d",label:"유사문제 생성",sub:"Solar Chat",row:1,col:0},{id:"e",label:"보충학습",sub:"계획 생성",row:1,col:1},{id:"f",label:"취약점 분석",sub:"단원별 통계",row:1,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"f"},{from:"f",to:"e"},{from:"e",to:"d"},{from:"d",to:"a"}]},5:{nodes:[{id:"a",label:"정책 데이터",sub:"브리핑·온통",row:0,col:0},{id:"b",label:"Solar Embed",sub:"벡터화",row:0,col:1},{id:"c",label:"pgvector",sub:"정책 DB",row:0,col:2},{id:"d",label:"사용자 대화",sub:'"나 25살..."',row:1,col:0},{id:"e",label:"프로파일 파악",sub:"나이·지역",row:1,col:1},{id:"f",label:"정책 매칭",sub:"RAG 검색",row:1,col:2},{id:"g",label:"쉬운말 안내",sub:"Solar Chat",row:2,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"f"},{from:"d",to:"e"},{from:"e",to:"f"},{from:"f",to:"g"}]},6:{nodes:[{id:"a",label:"경험 입력",sub:"자유 기술",row:0,col:0},{id:"b",label:"STAR 변환",sub:"구조화",row:0,col:1},{id:"c",label:"자소서 생성",sub:"문항별",row:0,col:2},{id:"d",label:"면접 코칭",sub:"Q&A 생성",row:1,col:1},{id:"e",label:"문장 피드백",sub:"개선 제안",row:1,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"e"},{from:"e",to:"d"}]},7:{nodes:[{id:"a",label:"감정 체크인",sub:'"오늘 기분?"',row:0,col:0},{id:"b",label:"상태 분석",sub:"수준·키워드",row:0,col:1},{id:"c",label:"루틴 추천",sub:"맞춤 1가지",row:0,col:2},{id:"d",label:"회복 트래커",sub:"추이 그래프",row:1,col:1},{id:"e",label:"격려 메시지",sub:"+ 성찰 질문",row:1,col:2},{id:"f",label:"루틴 수행",sub:"확인 (체크)",row:2,col:1}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"e"},{from:"e",to:"d"},{from:"f",to:"d"}]}},M=({projectId:s,color:t})=>{const o=D[s];if(!o)return null;const{nodes:h,arrows:c}=o,x=Object.fromEntries(h.map(a=>[a.id,a])),r=Math.max(...h.map(a=>a.col)),P=Math.max(...h.map(a=>a.row)),R=(r+1)*(d+A)-A+S*2,k=(P+1)*(p+f)-f+S*2,j=a=>({x:S+a.col*(d+A),y:S+a.row*(p+f),cx:S+a.col*(d+A)+d/2,cy:S+a.row*(p+f)+p/2}),N=a=>{const i=x[a.from],b=x[a.to];if(!i||!b)return null;const l=j(i),n=j(b),u=b.col-i.col,g=b.row-i.row;if(g===0&&u>0)return`M${l.x+d},${l.cy} L${n.x},${n.cy}`;if(g===0&&u<0)return`M${l.x},${l.cy} L${n.x+d},${n.cy}`;if(u===0&&g>0)return`M${l.cx},${l.y+p} L${n.cx},${n.y}`;if(u===0&&g<0)return`M${l.cx},${l.y} L${n.cx},${n.y+p}`;if(g>0){const _=l.cx,G=l.y+p,$=u>0?n.x:n.x+d,C=n.cy;return`M${_},${G} Q${_},${C} ${$},${C}`}const E=u>0?l.x+d:l.x,v=l.cy,I=n.cx,O=n.y+p;return`M${E},${v} Q${I},${v} ${I},${O}`},w=`arr-${s}`;return e.jsxs("svg",{viewBox:`0 0 ${R} ${k}`,className:"flow-diagram-svg",children:[e.jsx("defs",{children:e.jsx("marker",{id:w,markerWidth:"8",markerHeight:"6",refX:"7",refY:"3",orient:"auto",children:e.jsx("polygon",{points:"0,0 8,3 0,6",fill:t,fillOpacity:"0.7"})})}),c.map((a,i)=>{const b=N(a);return b?e.jsx("path",{d:b,fill:"none",stroke:t,strokeWidth:"1.5",strokeOpacity:"0.45",markerEnd:`url(#${w})`},i):null}),h.map(a=>{const i=j(a);return e.jsxs("g",{children:[e.jsx("rect",{x:i.x,y:i.y,width:d,height:p,rx:10,fill:"#fff",stroke:t,strokeWidth:"1.5",strokeOpacity:"0.6"}),e.jsx("text",{x:i.cx,y:a.sub?i.cy-7:i.cy+1,textAnchor:"middle",dominantBaseline:"middle",fontSize:"11.5",fontWeight:"600",fill:"#1f2937",children:a.label}),a.sub&&e.jsx("text",{x:i.cx,y:i.cy+9,textAnchor:"middle",dominantBaseline:"middle",fontSize:"9.5",fill:"#9ca3af",children:a.sub})]},a.id)})]})},m=({icon:s,title:t,children:o})=>e.jsxs("section",{className:"pgd-section",children:[e.jsxs("h2",{children:[e.jsx("span",{className:"pgd-section-icon",children:s})," ",t]}),e.jsx("div",{className:"pgd-card",children:o})]}),U=({project:s})=>e.jsxs(e.Fragment,{children:[e.jsxs(m,{icon:"ℹ️",title:"프로젝트 개요",children:[e.jsx("p",{className:"pgd-overview",children:s.overview}),e.jsxs("div",{className:"pgd-meta-grid",children:[e.jsxs("div",{children:[e.jsx("h4",{children:"주요 대상"}),e.jsx("ul",{children:s.targetUsers.map((t,o)=>e.jsx("li",{children:t},o))})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"학습 목표"}),e.jsx("ul",{children:s.objectives.map((t,o)=>e.jsx("li",{children:t},o))})]})]})]}),e.jsxs(m,{icon:"🏗️",title:"시스템 아키텍처",children:[e.jsx("p",{children:s.architecture.description}),e.jsx("div",{className:"pgd-diagram",children:e.jsx(M,{projectId:s.id,color:s.color})}),e.jsx("div",{className:"pgd-components",children:s.architecture.components.map((t,o)=>e.jsxs("div",{className:"pgd-component",children:[e.jsx("h4",{children:t.name}),e.jsx("p",{children:t.description}),e.jsx("span",{className:"pgd-tech-badge",children:t.tech})]},o))})]}),e.jsx(m,{icon:"🔄",title:"데이터 파이프라인",children:e.jsx("div",{className:"pgd-pipeline",children:s.pipeline.steps.map(t=>e.jsxs("div",{className:"pgd-pipeline-step",children:[e.jsx("div",{className:"pgd-step-num",style:{background:s.color},children:t.step}),e.jsxs("div",{className:"pgd-step-body",children:[e.jsx("h4",{children:t.title}),e.jsx("p",{children:t.description}),e.jsx("span",{className:"pgd-tech-badge",children:t.tools})]})]},t.step))})}),e.jsxs(m,{icon:"☀️",title:"Solar API 활용",children:[e.jsx("p",{children:s.solarApi.description}),s.solarApi.endpoints.map((t,o)=>e.jsxs("div",{className:"pgd-api-endpoint",children:[e.jsx("h4",{children:t.name}),e.jsx("p",{children:t.purpose}),e.jsx("div",{className:"pgd-code-block",children:e.jsx("code",{children:t.example})})]},o))]}),e.jsxs(m,{icon:"✨",title:"프롬프트 엔지니어링",children:[e.jsx("p",{children:s.prompts.description}),s.prompts.examples.map((t,o)=>e.jsxs("div",{className:"pgd-prompt",children:[e.jsx("h4",{children:t.title}),e.jsx("div",{className:"pgd-prompt-block",children:e.jsx("pre",{children:t.prompt})}),e.jsxs("p",{className:"pgd-prompt-note",children:["💡 ",t.note]})]},o))]}),e.jsxs(m,{icon:"💻",title:"구현 가이드",children:[e.jsxs("div",{className:"pgd-impl-grid",children:[e.jsxs("div",{className:"pgd-impl-item",children:[e.jsx("h3",{children:"🖥️ 프론트엔드"}),e.jsx("p",{children:s.implementation.frontend.description}),e.jsx("span",{className:"pgd-tech-badge",children:s.implementation.frontend.stack}),e.jsx("h4",{children:"주요 페이지"}),e.jsx("ul",{children:s.implementation.frontend.pages.map((t,o)=>e.jsx("li",{children:t},o))})]}),e.jsxs("div",{className:"pgd-impl-item",children:[e.jsx("h3",{children:"⚙️ 백엔드"}),e.jsx("p",{children:s.implementation.backend.description}),e.jsx("span",{className:"pgd-tech-badge",children:s.implementation.backend.stack}),e.jsx("h4",{children:"API 엔드포인트"}),e.jsx("ul",{children:s.implementation.backend.apis.map((t,o)=>e.jsx("li",{children:t},o))})]})]}),e.jsxs("div",{className:"pgd-db",children:[e.jsx("h3",{children:"🗄️ 데이터베이스"}),e.jsx("div",{className:"pgd-db-tables",children:s.implementation.database.tables.map((t,o)=>e.jsxs("div",{className:"pgd-db-table",children:[e.jsx("h4",{children:t.name}),e.jsx("code",{children:t.fields})]},o))})]})]}),e.jsxs(m,{icon:"🚀",title:"배포 계획",children:[e.jsx("span",{className:"pgd-tech-badge",children:s.deployment.infra}),e.jsx("ol",{className:"pgd-deploy-steps",children:s.deployment.steps.map((t,o)=>e.jsx("li",{children:t},o))})]}),e.jsx(m,{icon:"🌟",title:"확장 가능성",children:e.jsx("ul",{className:"pgd-expansion",children:s.expansion.map((t,o)=>e.jsxs("li",{children:[e.jsx("span",{style:{color:s.color},children:"✓"})," ",t]},o))})})]}),Q=()=>{const{id:s}=L(),t=B(),[o,h]=T.useState(s?Number(s):1);T.useEffect(()=>{s&&h(Number(s))},[s]);const c=y.find(r=>r.id===o)||y[0],x=r=>{h(r),t(`/project-guide/${r}`,{replace:!0}),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs(e.Fragment,{children:[e.jsx(F,{title:c.title,path:`/project-guide/${o}`}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h2",{children:"프로젝트 안내"}),e.jsx("p",{children:"지역문제 해결형 PBL 프로젝트의 참고 가이드입니다. 생성형 AI를 활용한 실전 프로젝트 사례를 살펴보고 팀 산출물 설계에 참고하세요."})]})}),e.jsxs("div",{className:"sidebar-layout",children:[e.jsx("aside",{className:"sidebar",children:e.jsx("nav",{className:"sidebar-menu",children:y.map(r=>e.jsx("button",{className:`sidebar-item ${r.id===o?"active":""}`,onClick:()=>x(r.id),children:e.jsx("span",{className:"sidebar-item-text",children:r.title})},r.id))})}),e.jsxs("div",{className:"sidebar-content",children:[e.jsxs("div",{className:"pgd-hero-card",style:{borderLeftColor:c.color},children:[e.jsx("span",{className:"pgd-hero-icon",style:{background:`${c.color}18`,color:c.color},children:c.icon}),e.jsxs("div",{children:[e.jsx("h3",{className:"pgd-hero-title",children:c.title}),e.jsx("p",{className:"pgd-hero-subtitle",children:c.subtitle}),e.jsx("div",{className:"pg-card-tags",style:{marginTop:"8px"},children:c.solarApi.endpoints.map((r,P)=>e.jsx("span",{className:"pg-tag",children:r.name.split(" (")[0]},P))})]})]}),e.jsx(U,{project:c})]})]})]})};export{Q as default};
